        ...
        <>
            ...
            <form className="flex flex-col gap-8 mb-16">
                ...
                <div className="flex flex-col gap-2 bg-white p-4 rounded-xl">
                    ...
                    <p>Lain-lain</p>
                    <textarea name="other" id="other" rows={5} className="w-full rounded-lg border border-gray-300 p-3"></textarea>
                </div>
                ...
                <div className="flex flex-col gap-2 bg-white p-4 rounded-xl">
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="penjualan" className="w-1/3 rounded-lg border border-gray-300 p-3" />
                        <p className="text-base w-full">Servis Mesin</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <input type="number" id="penjualan" className="w-1/3 rounded-lg border border-gray-300 p-3" />
                        <p className="text-base w-full">Servis Kelengkapan Motor</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <input type="number" id="penjualan" className="w-1/3 rounded-lg border border-gray-300 p-3" />
