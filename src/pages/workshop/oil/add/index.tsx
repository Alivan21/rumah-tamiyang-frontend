...
import { OilWasteRequest, useAddOilWaste } from "@/hooks/workshop/oil-waste";
...
function AddOil() {
  ...
  const [form, setForm] = useState<OilWasteRequest>({
    day: 0,
    month: "01",
    year: 0,
    oil_collects: 0,
  ...
  const { mutateAsync: AddOilMutation } = useAddOilWaste(form);
  ...
  return (
    <>
      <div className="mb-3 flex items-center gap-3">
        ...
        <h1 className="text-xl font-semibold">Tambah Oli</h1>
      </div>
